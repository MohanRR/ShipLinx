...
public class ExceptionListAction extends DataGridAction {
	...
	public String list() throws Exception {
		...
		if (rowCount > 0) {
			...
			getDataGrid().setDataRows(service.findExceptions(criteria, getDataGrid()
					.getCurPageRowStartIndex(), getDataGrid()
	...
	public List<ExceptionInfoVO> refreshDataRows() throws Exception {
		List<ExceptionInfoVO> exceptionList = service.findExceptions(criteria, 
				getDataGrid().getCurPageRowStartIndex(), getDataGrid().getCurPageRowEndIndex());
