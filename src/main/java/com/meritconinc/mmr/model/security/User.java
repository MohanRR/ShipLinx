...
public class User implements Serializable {
	...
	/**
	 * @param authorizedActions the authorizedActions to set
	 */
	public void setAuthorizedActions(
			Collection<AuthorizedActionVO> authorizedActions) {
	...
	public boolean isPasswordExpired() {
		...
		String prop = WebUtil.getProperty(
				Constants.SYSTEM_SCOPE, Constants.PASSWORD_EXPIRES_DAYS);
