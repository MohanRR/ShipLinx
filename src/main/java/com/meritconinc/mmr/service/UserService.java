...
public interface UserService {
	...
	public void addRequestAccess(final User user) throws EmailAlreadyRegisteredException, UsernameAlreadyTakenException;
	public User findUserByUsername(String username);
	public void create(User user, String changedBy) throws EmailAlreadyRegisteredException, UsernameAlreadyTakenException;
//	public void add(User user) throws EmailAlreadyRegisteredException,UsernameAlreadyTakenException;
...
//	public void edit(User user);
	...
	public void changePassword(String username, String existingPassword, String newPassword,
			String changedBy, boolean isAdmin) throws InvalidPasswordException, SameOldPasswordException, RepeatedPasswordException;	
