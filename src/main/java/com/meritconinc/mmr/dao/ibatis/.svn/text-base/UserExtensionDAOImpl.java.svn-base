...
public class UserExtensionDAOImpl extends SqlMapClientDaoSupport implements UserExtensionDAO{
	...
	public UserExtendedAttributes getExtendedAttributesByUsername(String username) {
		...
		params.put("username", username);
		return (UserExtendedAttributes)getSqlMapClientTemplate().queryForObject("getExtendedAttributesByUsername", params);
	}
	...
	public void insertExtendedAttributes(String username,
			UserExtendedAttributes attributes) {
	...
	public void updateExtendedAttributes(String username,
			UserExtendedAttributes attributes) {
