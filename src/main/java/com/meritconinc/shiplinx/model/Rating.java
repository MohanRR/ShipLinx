...
public class Rating implements Serializable{
	...
	private long originalServiceId; //Used in DHL to remember the "real" service. See rateShipment function, line 122
	...
	private String billWeightUOM = ShiplinxConstants.WEIGHT_UNITS_LBS; //Currently the system only accepts and quotes on LBS.
	...
	private boolean ups_extended_area; //indicator that rating response has an extended area surcharge included, to be used for Canada extended area surcharge
	...
	//Booking key to be remembered, some carriers send a key in the rating response and this key needs to be sent at booking/shipping time
