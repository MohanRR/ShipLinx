...
public class CarrierServiceDAOImpl extends SqlMapClientDaoSupport implements CarrierServiceDAO{
	...
	public List<CustomerCarrier> getCutomerCarrier(Long customerId) {
		...
		List<CustomerCarrier> customerCarrierList =  (List)getSqlMapClientTemplate().queryForList("getCustomerCarrier", paramObj);
	...
	public List<Service> getServicesForCarrier(Long carrierId) {
		...
		try{
			carrierServicesList =  (List)getSqlMapClientTemplate().queryForList("getServicesForCarrier", paramObj);
		}catch (Exception e) {
			e.printStackTrace();
		}
	...
	public Carrier getCarrierByBusiness(Long carrierId, Long businessId){
		...
		Carrier carrier =  (Carrier)getSqlMapClientTemplate().queryForObject("getCarrierByBusiness", paramObj);
		return carrier;
	...
	public Service getServiceByCarrierIdAndTransitCode(Long carrierId, String transitCode){
		...
		Service service =  (Service)getSqlMapClientTemplate().queryForObject("getServiceByCarrierIdAndTransitCode", paramObj);
		return service;
	...
	public Service getServiceByCarrierIdAndCode(Long carrierId, String code){
		...
		Service service =  (Service)getSqlMapClientTemplate().queryForObject("getServiceByCarrierIdAndCode", paramObj);
		return service;
	...
	public CustomerCarrier getCutomerCarrierDefaultAccount(long carrierId,long customerId) {
		...
		paramObj.put("carrierId", carrierId);
		paramObj.put("customerId", customerId);
		CustomerCarrier customerCarrier =  (CustomerCarrier)getSqlMapClientTemplate().queryForObject("getCutomerCarrierDefaultAccount", paramObj);
	...
	public CustomerCarrier getDefAccountByCountry(long carrierId,long customerId,String country) {
		...
		CustomerCarrier customerCarrier =  (CustomerCarrier)getSqlMapClientTemplate().queryForObject("getDefAccountByCountry", paramObj);
		return customerCarrier;
	}
	...
	public CustomerCarrier getOrderCutomerCarrier(Long orderId) {
		...
		CustomerCarrier customerCarrier = (CustomerCarrier)getSqlMapClientTemplate().queryForObject("getOrderCustomerCarrier", paramObj);
		return customerCarrier;
	}
	...
	public List<CustomerCarrier> getAllCutomerCarrier(long businessId, Long customerId) {
		...
		paramObj.put("customerId", customerId);
		paramObj.put("businessId", businessId);
		List<CustomerCarrier> customerCarrierList =  (List)getSqlMapClientTemplate().queryForList("getAllCustomerCarrier", paramObj);
		return customerCarrierList;
	}
	...
	public List<CustomerCarrier> getCarrierAccounts(Long customerId, String country) {
		...
		paramObj.put("customerId", customerId);
		paramObj.put("country", country);
		List<CustomerCarrier> customerCarrierList =  (List)getSqlMapClientTemplate().queryForList("getCarrierAccounts", paramObj);
		return customerCarrierList;
	}
	...
	public CustomerCarrier getCarrierAccount(Long customerId, Long businessId, Long carrierId, String country, String toCountry) {
		...
		CustomerCarrier customerCarrierList =  (CustomerCarrier)getSqlMapClientTemplate().queryForObject("getCarrierAccount", paramObj);
		return customerCarrierList;
	}

	public List<Carrier> getCarriersForBusiness(long businessId){
		List<Carrier> carrierList =  (List)getSqlMapClientTemplate().queryForList("getAllCarrierForBusiness", businessId);
		return carrierList;
	}
	...
	public Long getMaxServiceIdForCarrier(long carrierId){
		Map<String, Object> paramObj = new HashMap<String, Object>(1);
		paramObj.put("carrierId", carrierId);
		Long maxServiceId =  (Long)getSqlMapClientTemplate().queryForObject("getMaxServiceIdForCarrier", paramObj);
		return maxServiceId;
...
//			log.debug("-----Exception-----"+e);
	...
	public List<CustomerCarrier> getAllCustomersCarrier(long businessId, long carrierId) {
		...
		paramObj.put("businessId", businessId);
		paramObj.put("carrierId", carrierId);
		List<CustomerCarrier> customerCarrierList =  (List)getSqlMapClientTemplate().queryForList("getAllCustomersCarrier", paramObj);
		return customerCarrierList;
	}
