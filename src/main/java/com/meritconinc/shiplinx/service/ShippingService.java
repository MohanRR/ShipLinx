...
public interface ShippingService{
	...
	public void updateStatus(Long long1, Long long2, long statusDelivered, String comment) throws Exception;
	...
	public List<ShippingOrder> processBatchShipments(List<ShippingOrder> shipments, BatchShipmentInfo batchInfo);
